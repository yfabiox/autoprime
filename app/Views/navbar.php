    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div id="menu"
            ...
            <a href="<?= url_to('Home') ?>"
                ...
                <?= ($uri->getSegment(1) === '' || $uri->getSegment(1) === 'home') ? 'border-b-2 border-red-500 ' : '' ?>">
                Home
                <span
                    class="absolute left-0 bottom-0 w-0 h-0.5 bg-red-400 group-hover:w-full transition-all duration-300"></span>
            </a>

            <a href="<?= url_to('Carros_Search') ?>" class="text-gray-300 hover:text-red-400 transition-colors duration-300 font-medium relative group 
                <?= (strpos($currentUrl, 'carros/search') !== false) ? 'border-b-2 border-red-500 ' : '' ?>">
                Carros
                <span
                    class="absolute left-0 bottom-0 w-0 h-0.5 bg-red-400 group-hover:w-full transition-all duration-300"></span>
            </a>
